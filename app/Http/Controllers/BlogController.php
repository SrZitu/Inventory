...
class BlogController extends Controller
{
    ...
    public function Addblog()
    {
        ...
        return view('admin.blogs.blog_add', compact('blog_category'));
    }
    ...
    public function storeBlog(Request $request)
    {
        ...
        $request->validate(
            ...
            [
                'blog_title.required' => 'Name is required',
                'blog_image.required' => 'Image is required',
                'blog_tags.required' => 'Tag must be given',
                'blog_description.required' => 'Please give some description',
    ...
    public function updateBlog(Request $request)
    {
        ...
        if ($request->file('blog_image')) {
            ...
            return redirect()->route('blog_all.page')->with($notification);
        } else {
    ...
    public function deleteBlog($id){
     ...
     public function BlogDetails($id){
        ...
        $blogs=Blog::findOrFail($id);
        $blog_category = BlogCategory::orderBy('blog_category', 'ASC')->get();
        return view('frontend.blog_details',compact('blogs','allblogs','blog_category'));
     }
