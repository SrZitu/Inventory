            ...
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        ...
                        <li><a href="{{ route('multiImage.page') }}">Multi Image Page</a></li>
                        <li><a href="{{ route('all.multiImage.page') }}">All Multi Image Page</a></li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{ route('portfolio_all.page') }}">Porftolio All Page</a></li>
                        <li><a href="{{ route('portfolio.page') }}">Add Porftolio Page</a></li>
                    </ul>
                </li>
                ...
                <li>
                    ...
                    <ul class="sub-menu" aria-expanded="false">
                        <li><a href="{{ route('footer.page') }}">Footer Page</a></li>
                    </ul>
                </li>
