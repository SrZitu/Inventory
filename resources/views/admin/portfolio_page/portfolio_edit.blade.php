                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="portfolio_name" class="form-control" type="text"
                                            value="{{ $portfolio_id->portfolio_name }}" id="example-text-input">
                                    </div>
                                </div>
                                <!-- end row -->
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input name="portfolio_title" class="form-control" type="text"
                                            value="{{ $portfolio_id->portfolio_title }}" id="example-text-input">
                                    </div>
                                </div>
                                <!-- end row -->
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea id="elm1" name="portfolio_description">
                                          {{ $portfolio_id->portfolio_description }}
                                         </textarea>
                                    </div>
                                </div>
                                <!-- end row -->
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <img id="showImage" class="rounded avatar-lg"
                                            src="{{ !empty($portfolio_id->portfolio_image) ? url($portfolio_id->portfolio_image) : url('upload/noimage.jpg') }}"
                                            alt="Card image cap">
                                    </div>
                                </div>
                                <!-- end row -->
