                ...
                <div class="row">
                    <div class="col-lg-8">
                            ...
                            <div class="standard__blog__post">
                                ...
                                <div class="standard__blog__content">
                                    <div class="blog__post__avatar">
                                        ...
                                        <span class="post__by">By : <a href="#">Md. Sazzadur Rahman Zitu</a></span>
                                    </div>
                                    ...
                                    <ul class="blog__post__meta">
                                        <li><i class="fal fa-calendar-alt"></i>
                                            ...
                                            {{-- this will show only limited charecter --}}
                        ...
                        <div class="pagination-wrap">
                            {{-- //this was for default pagination --}}
                           {{-- {{$allblogs->links()}} --}}
                                        ...
                                        <li class="rc__post__item">
                                            ...
                                            <div class="rc__post__content">
                                                ...
                                                <span class="post-date"><i class="fal fa-calendar-alt"></i>
                                                    {{ $all->created_at->diffForHumans() }} </span>
                                            </div>
                                        </li>
                                    @endforeach
                                ...
                                <ul class="sidebar__cat">
                                    @foreach ($categories as $category)
                                        <li class="sidebar__cat__item"><a
                                                href="{{ route('category.blog', $category->id) }}">{{ $category->blog_category }}
                                            </a></li>
                                    @endforeach
                                </ul>
                            </div>
